...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-[#0B0F1A] text-white">
      ...
      {/* ═══════ SERVICES ═══════ */}
      <section id="services" className="border-b border-white/[.06] py-20 sm:py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="max-w-xl">
              <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[.22em] text-[#FFC300]">
                <span className="font-display text-gray-500">01</span>
                <span className="h-px w-8 bg-[#FFC300]/40" />
                {t.services.eyebrow}
              </p>
              <h2 className="mt-5 font-display text-4xl font-normal leading-[1.1] text-white sm:text-5xl">
                {t.services.heading}
              </h2>
            </div>
            <a href="/services"
      ...
      {/* ═══════ RENTALS ═══════ */}
      <section className="border-b border-white/[.06] bg-[#0E1322] py-20 sm:py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-xl">
            <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[.22em] text-[#FFC300]">
              <span className="font-display text-gray-500">02</span>
              <span className="h-px w-8 bg-[#FFC300]/40" />
              {t.rentals.eyebrow}
            </p>
            <h2 className="mt-5 font-display text-4xl font-normal leading-[1.1] text-white sm:text-5xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4 lg:mt-16">
            {rentals.map((r, i) => (
              <ServiceCard key={r.title} title={r.title} description={r.desc} slug={r.slug} image={r.image} index={i + 1} />
            ))}
          </div>
        </div>
      </section>
      ...
      {/* ═══════ WHY CHOOSE US ═══════ */}
      <section id="aboutus" className="border-b border-white/[.06] py-20 sm:py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-5">
              <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[.22em] text-[#FFC300]">
                <span className="font-display text-gray-500">03</span>
                <span className="h-px w-8 bg-[#FFC300]/40" />
                {t.why.eyebrow}
              </p>
              <h3 className="mt-5 font-display text-4xl font-normal leading-[1.1] text-white sm:text-5xl">
                {t.why.title1} <span className="italic text-white/60">{t.why.title2}</span>
              </h3>
              ...
              <ul className="mt-8 space-y-4">
                {t.why.points.map((p, i) => (
                  <li key={p} className="flex items-start gap-4 border-t border-white/10 pt-4 text-sm text-gray-200">
      ...
      {/* ═══════ MORE REVIEWS ═══════ */}
      <section id="reviews" className="border-b border-white/[.06] bg-[#0E1322] py-20 sm:py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-xl">
            <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[.22em] text-[#FFC300]">
              <span className="font-display text-gray-500">04</span>
              <span className="h-px w-8 bg-[#FFC300]/40" />
              {t.reviews.eyebrow}
            </p>
            <h2 className="mt-5 font-display text-4xl font-normal leading-[1.1] text-white sm:text-5xl">
              {t.reviews.heading1} <span className="italic text-white/60">{t.reviews.heading2}</span>
            </h2>
          </div>
      ...
      <section className="py-20 sm:py-28 lg:py-36">
        <div className="mx-auto max-w-6xl px-5 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[.22em] text-[#FFC300]">
                <span className="font-display text-gray-500">05</span>
                <span className="h-px w-8 bg-[#FFC300]/40" />
                {t.cta.badge}
              </p>
              <h2 className="mt-5 font-display text-4xl font-normal leading-[1.05] text-white sm:text-5xl lg:text-6xl">
                {t.cta.title1} <span className="italic text-white/60">{t.cta.title2}</span>
              </h2>
              ...
              <div className="mt-10 grid grid-cols-3 gap-6 border-t border-white/10 pt-8 sm:max-w-md">
                <div>
                  ...
                  <div className="mt-2 text-[10px] font-semibold uppercase tracking-[.18em] text-gray-500">{t.cta.stats.jobs}</div>
                </div>
                <div>
                  <div className="font-display text-3xl text-white">5.0</div>
                  <div className="mt-2 text-[10px] font-semibold uppercase tracking-[.18em] text-gray-500">{t.cta.stats.rating}</div>
                </div>
                <div>
                  <div className="font-display text-3xl text-white">24h</div>
                  <div className="mt-2 text-[10px] font-semibold uppercase tracking-[.18em] text-gray-500">{t.cta.stats.response}</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-end gap-4 lg:col-span-5">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2.5 rounded-sm bg-[#FFC300] px-7 py-4 text-sm font-semibold tracking-wide text-black transition hover:bg-white"
              >
                {t.cta.whatsapp}
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 rounded-sm border border-white/20 px-7 py-4 text-sm font-semibold tracking-wide text-white transition hover:border-white/60"
              >
                +5999 511 2097
              </a>
