...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    servicesPage: {
      ...
      pricingPoints: [
        "All prices are in Antillean guilders (ƒ) and are starting points.",
        ...
        "We serve all areas in Curaçao — some zones may include a small travel fee.",
        "Weekend & emergency call-out rates may apply.",
      ],
  ...
  es: {
    ...
    servicesPage: {
      ...
      pricingPoints: [
        "Todos los precios están en florines antillanos (ƒ) y son puntos de partida.",
        ...
        "Atendemos toda Curazao — algunas zonas pueden incluir un pequeño cargo por desplazamiento.",
        "Pueden aplicar tarifas de fin de semana o emergencia.",
      ],
  ...
  nl: {
    ...
    servicesPage: {
      ...
      pricingPoints: [
        "Alle prijzen zijn in Antilliaanse guldens (ƒ) en richtprijzen.",
        ...
        "Wij bedienen heel Curaçao — sommige gebieden kunnen een kleine reistoeslag hebben.",
        "Weekend- en spoedtarieven kunnen van toepassing zijn.",
      ],
  ...
  pap: {
    ...
    servicesPage: {
      ...
      pricingPoints: [
        "Tur preis ta den florín antiano (ƒ) i ta punto di salida.",
        ...
        "Nos ta sirbi henter Kòrsou — algun zona por tin un kosto di biahe chikí.",
        "Tarifa di fin di siman i emergensia por aplicá.",
      ],
